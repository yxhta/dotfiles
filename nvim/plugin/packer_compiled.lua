...
_G.packer_plugins = {
  ...
  ["filetype.nvim"] = {
    loaded = true,
    path = "/Users/REDACTED/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/REDACTED/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
